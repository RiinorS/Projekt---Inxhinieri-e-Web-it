...
<head>
    ...
    <link rel="stylesheet" href="../css_code/dashboard.css">
...
<body>
    ...
    <div  class="menu-anash">
        ...
        <li> <a href="../phpfaza2/porositedash.php"> <img src="../images/cart.png" width="22px" height="20px" >&nbsp; <span> Porositë</span></a>  </li>
